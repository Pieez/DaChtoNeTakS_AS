...
public class LogIn extends AppCompatActivity {
    ...
    public void Profile(View v){
        if (email.getText().toString().equals("")||password.getText().toString().equals("")){
            Toast.makeText(LogIn.this,"заполните пожалуйста поля", Toast.LENGTH_SHORT).show();
        }
        else{
            ...
            if (bool){
                ...
                Toast.makeText(LogIn.this, "заполните емайл", Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        call.enqueue(new Callback<UserMask>() {
            ...
            public void onResponse(Call<UserMask> call, Response<UserMask> response) {
                if (!response.isSuccessful()){
                    Toast.makeText(LogIn.this, "Пользователь отсуствует или неправильно введен логин и пароль", Toast.LENGTH_SHORT).show();
                    return;
                }
